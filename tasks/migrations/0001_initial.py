...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('code', models.CharField(max_length=11, primary_key=True, serialize=False, verbose_name='Код 1С')),
                ('name', models.CharField(max_length=1000, verbose_name='Имя группы')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='basics',
            name='group',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='basics_groups', to='tasks.resultgroup'),
        ),
        migrations.AddField(
